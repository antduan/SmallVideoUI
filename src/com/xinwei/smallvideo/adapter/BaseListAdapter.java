...
import com.xinwei.smallvideo.holder.BaseHolder;
import com.xinwei.smallvideo.manager.ThreadManager;
	...
	protected View getMoreView(int position, View convertView, ViewGroup parent)
	{
		...
		if (mHasMore)
		{
			if (mIsLoading && !mLoadError)
			{
				if (mLoadingView == null)
				{
					mLoadingView = mActivity
							.inflate(R.layout.list_view_more_loading);
				}
				view = mLoadingView;
			}
			else
			{
				if (mErrorView == null)
				{
					mErrorView = mActivity
							.inflate(R.layout.list_view_load_error);
				}
				view = mErrorView;
			}
		}
