...
package com.xinwei.smallvideo.country;
	...
	public View getView(int position, View view, ViewGroup parent)
	{
		...
		if (view == null)
		{
			...
			view = LayoutInflater.from(mContext).inflate(
					R.layout.login_activity_select_country_item, null);
			viewHolder.country_sortName = (TextView) view
					.findViewById(R.id.country_catalog);
			viewHolder.country_name = (TextView) view
					.findViewById(R.id.country_name);
			viewHolder.country_number = (TextView) view
					.findViewById(R.id.country_number);
		...
		viewHolder.country_number
				.setText(this.mList.get(position).countryNumber);
