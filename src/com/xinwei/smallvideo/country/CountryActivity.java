...
import com.xinwei.smallvideo.activity.MainActivity;
import com.xinwei.smallvideo.country.SideBar.OnTouchingLetterChangedListener;
	...
	private void setListener()
	{
		...
		country_lv_countryList.setOnItemClickListener(new OnItemClickListener()
		{
					...
					int position, long arg3)
			{
				...
				Log.e(TAG, "countryName: + " + countryName + "countryNumber: "
						+ countryNumber);
				finish();
