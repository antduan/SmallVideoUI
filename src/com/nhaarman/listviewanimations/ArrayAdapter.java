...
/**
 * A true {@link ArrayList} adapter providing access to some of the
 * {@code ArrayList} methods.
 * <p/>
 * Also implements {@link Swappable} for easy object swapping, and
 * {@link com.nhaarman.listviewanimations.util.Insertable} for inserting
 * objects.
 */
		...
		Insertable<T>
{
	...
	/**
	 * Creates a new ArrayAdapter, using (a copy of) given {@code List}, or an
	 * empty {@code List} if objects = null.
	 */
	protected ArrayAdapter(@Nullable
	...
	@Override
	public void add(final int index, @NonNull
	final T item)
	{
	...
	public void propagateNotifyDataSetChanged(@NonNull
	final BaseAdapter slavedAdapter)
	{
